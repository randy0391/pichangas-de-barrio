...
export const NewsPage = () => {
    ...
    const filtered = filter === 'Todas' ? posts : (posts as Post[]).filter(p => p.category === filter);
...
export const EventsPage = () => {
    ...
    const filtered = (events as Event[]).filter(e => e.status === filter);
    ...
    return (
        <div className="container mx-auto p-4 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card><CardHeader><CardTitle>Convocatorias Próximas</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{dashData?.stats?.upcoming_convocatorias_count || 0}</CardContent></Card>
                <Card><CardHeader><CardTitle>Eventos Registrados</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{dashData?.stats?.registered_events || 0}</CardContent></Card>
                <Card><CardHeader><CardTitle>Total Participaciones</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{dashData?.stats?.total_participations || 0}</CardContent></Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                    ...
                    <div className="space-y-4">
                        {dashData?.upcoming_convocatorias?.map((c) => (
                            <Card key={c.id}>
...
export const ConvocatoriasPage = () => {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="space-y-4">
                {(convocatorias as Convocatoria[]).map(c => (
                    <Card key={c.id}>
...
export const MisParticipacionesPage = () => {
    ...
    if (!Array.isArray(participaciones) || participaciones.length === 0) return <div className="p-8 text-center text-gray-500">No hay participaciones.</div>;

    return (
        <div className="container mx-auto p-4">
            <h1 className="text-3xl font-bold mb-6">Mis Participaciones</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {(participaciones as any[]).map((p: any) => (
                    <Card key={p.id}>
                        <CardContent className="p-4 flex justify-between items-center">
                            <div>
    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                <Card><CardHeader><CardTitle>Total Miembros</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{adminStats?.stats?.total_members || 0}</CardContent></Card>
                <Card><CardHeader><CardTitle>Convocatorias Activas</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{adminStats?.stats?.active_convocatorias || 0}</CardContent></Card>
                <Card><CardHeader><CardTitle>Total Eventos</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{adminStats?.stats?.total_events || 0}</CardContent></Card>
                <Card><CardHeader><CardTitle>Total Posts</CardTitle></CardHeader><CardContent className="text-3xl font-bold">{adminStats?.stats?.total_posts || 0}</CardContent></Card>
            </div>
        </div>
    );
};
